...
export const Hero: React.FC = () => {
  return (
    <section className="relative w-full">
      ...
      <div className="relative w-full min-h-[500px] lg:h-[600px] text-white flex items-center justify-center py-12 lg:py-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full max-w-[1728px] px-5 lg:px-[144px] z-10 h-full relative">
          {/* Left Content */}
          <div className="flex flex-col gap-[20px] lg:gap-[30px] max-w-full lg:max-w-[550px] justify-center h-full pt-0 lg:pt-10 items-center lg:items-start text-center lg:text-left">
            <h1 className="flex flex-col font-bold leading-tight">
              <span className="text-[28px] md:text-[32px] lg:text-[40px] text-white opacity-95">Profuture Teknoloji Dergisi</span>
              <span className="text-[32px] md:text-[36px] lg:text-[48px] text-white">Son Sayı Yayında</span>
            </h1>
            <p className="text-[16px] lg:text-[17px] leading-[24px] lg:leading-[26px] text-white/90 font-light max-w-[480px]">
              Profuture teknoloji mekanizmaları değişikliği alanlarında özgün akademik çalışmalar içeren yeni sayıya şimdi erişin.
            </p>

            {/* Metadata Icons */}
            <div className="flex gap-[15px] lg:gap-[25px] items-center flex-wrap justify-center lg:justify-start pt-2">
              <div className="flex items-center gap-[8px] text-white text-[14px] lg:text-[15px] font-medium opacity-90">
            ...
            <a href="#" className="mt-4 flex w-fit px-6 lg:px-8 py-3 lg:py-4 items-center gap-[10px] rounded-full bg-white/10 border border-white/20 text-white text-[15px] lg:text-[16px] font-medium backdrop-blur-sm hover:bg-white hover:text-primary-blue transition-all duration-300 group">
      ...
      <div className="w-full bg-white py-12 lg:py-24 lg:pb-32">
        <div className="max-w-[1728px] mx-auto px-5 lg:px-[144px]">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
            {/* About Content */}
            <div className="flex-1 max-w-full lg:max-w-[650px] pt-0 lg:pt-12 text-center lg:text-left">
              <h3 className="text-[#676A73] text-[14px] lg:text-[16px] font-semibold uppercase tracking-wider mb-2">Dergi Amacı ve Kapsamı</h3>
              <h2 className="text-[28px] lg:text-[32px] font-bold text-primary-navy mb-6">Profuture Teknoloji Dergisi</h2>
              <p className="text-[15px] lg:text-[16px] leading-[26px] lg:leading-[28px] text-text-dark/80 text-justify mb-8">
              ...
              <a href="#" className="btn btn-light-outline rounded-full px-8 inline-flex items-center gap-2">
                Detay
